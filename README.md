...
<div align="center">
    <img src="https://github.com/Ventu012/P4_BehavioralCloning/report_images/video_gif.gif" width="500" />
</div>
...
My first step was to use the convolution neural network model used in the NVIDIA's End to End Learning for Self-Driving Cars paper (Reference: https://arxiv.org/pdf/1604.07316v1.pdf). <br>
<div align="center">
    <img src="https://github.com/Ventu012/P4_BehavioralCloning/report_images/cnn.png" width="500" />
</div>
...
<div align="center">
    <img src="https://github.com/Ventu012/P4_BehavioralCloning/report_images/center.jpg" width="500" />
</div>
...
<div align="center">
    <img src="https://github.com/Ventu012/P4_BehavioralCloning/report_images/recover_1.jpg" width="500" />
</div>
<div align="center">
    <img src="https://github.com/Ventu012/P4_BehavioralCloning/report_images/recover_2.jpg" width="500" />
</div>
<div align="center">
    <img src="https://github.com/Ventu012/P4_BehavioralCloning/report_images/recover_3.jpg" width="500" />
</div>

To augment the data sat, I also flipped images and angles. <br>

I used this data for training (0.8) and validation (0.2). The validation set helped determine if the model was over or under fitting. <br>
...
In the end I run the simulator to see how well the car was driving around track one. There are a few spots where the vehicle deviate from the center of the track but quickly returns to the center line of the track.

The result is that the vehicle is able to drive autonomously around the track without leaving the road.
